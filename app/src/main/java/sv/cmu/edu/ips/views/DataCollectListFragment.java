 ...
 * currently being viewed in a {@link DataCollectDetailFragment}.
 * <p/>
 * Activities containing this fragment MUST implement the {@link Callbacks}
 * interface.
 */
public class DataCollectListFragment extends ListFragment {
    ...
    public List<SensorDataCollector> sensorDataCollectors;

    /**
     * Mandatory empty constructor for the fragment manager to instantiate the
     * fragment (e.g. upon screen orientation changes).
     */
    public DataCollectListFragment() {
    }
    ...
    public List<SensorDataCollector> getActiveSensorProbes(){
